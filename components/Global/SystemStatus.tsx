    ...
    >
      <div className="flex items-center gap-3 sm:gap-4">
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-full animate-pulse bg-[#ffe880] ring-1 ring-[#bf0039]" />
      ...
      <div className="hidden xs:block text-[9px] sm:text-[10px] font-mono uppercase tracking-wider font-semibold text-white/60">
        Coimbatore, India 📍
      </div>
    </motion.div>
  );
